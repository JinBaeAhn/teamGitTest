...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<div class="page-content">
		...
		<form action="/noticeUpdate.do" method="post" class="row g-3">
			...
			<div class="form-group"><textarea class="form-control" name="noticeContent" id="noticeContent" rows="20"placeholder="내용을 입력해주세요" required><%=notice.getNoticeContent()%></textarea></div>
